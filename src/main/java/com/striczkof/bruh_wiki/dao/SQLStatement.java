...
enum SQLStatement {
    ...
    ART_ADMIN_GET_COUNT("SELECT COUNT(id) AS 'count' FROM articles IS FALSE"),
    ART_ADMIN_GET_COUNT_BY_CAT("SELECT COUNT(id) AS 'count' FROM articles IS FALSE AND category_id = ?"),
